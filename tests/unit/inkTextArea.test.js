...
describe('InkTextArea input handling', () => {
  ...
  test('drops base command matches when query tokens extend beyond the label', async () => {
    const slashItems = [
      {
        id: 'model',
        label: 'model',
      ...
      { id: 'model-gpt-4o', label: 'model gpt-4o', description: 'Flagship model' },
      { id: 'model-gpt-4o-mini', label: 'model gpt-4o-mini', description: 'Smaller sibling' },
    ];
    ...
    expect(frame).toContain('model gpt-4o-mini');
