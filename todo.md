...
- [x] `packages/core/src/agent/promptCoordinator.ts` – Simplified prompt coordination guards and defaults to lower complexity while preserving the existing state machine contract.
