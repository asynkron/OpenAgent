...
- Utilities centralize formatting (e.g., `progressUtils.js`) to keep visual logic consistent across components, and only named exports remain so tree-shaking tools no longer flag unused default wrappers.
