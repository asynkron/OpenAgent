...
import type { requestModelCompletion as RequestModelCompletion } from '../openaiRequest.js';
...
export interface DebugMetadata extends Record<string, unknown> {
  stage: string;
}
...
export interface AssistantResponseSuccess {
  status: 'success';
  parsed: Record<string, unknown> & { plan?: PlanStep[] | null; message?: string | null };
